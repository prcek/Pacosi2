...
import LessonsReportTable from './LessonsReportTable';
...
class LessonsReport extends React.Component {
    ...
    checkFilter() {
        return  this.checkFilterField('month',this.state.filter.month);
    }
    ...
    render() {
        ...
        return (
            ...
            <Typography className={classes.typo} variant="title"> Přehled lekcí </Typography>
            ...
            {this.checkFilter() && <LessonsReportTable  month={this.state.filter.month} /> }  
